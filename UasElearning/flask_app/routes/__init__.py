...
from .akademik_routes import akademik_bp
from .materi_routes import materi_bp


__all__ = ["main_bp", "matakuliah_bp", "auth_bp", "dosen_bp", "mahasiswa_bp", "kelas_bp", "mk_bp", "tugas_bp", "penyerahan_bp", "penilaian_bp", "akademik_bp", "materi_bp"]
