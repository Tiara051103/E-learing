...
from application.matkul_use_case import MatkulUseCase
from application.nilai_use_case import NilaiUseCase
from application.mahasiswa_use_case import MahasiswaUseCase

akademik_bp = Blueprint("akademik", __name__, url_prefix="/")
